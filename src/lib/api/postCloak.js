...
class PostCloak {
  constructor (hostname, token, provider, organizationPublicKey, organizationPrivateKeyEncryptedWithUserPublicKey, usernameName, filepath, publicKeyName, privateKeyName, publicKey, privateKeyEncryptedWithOrganizationPublicKey) {
    this.hostname = hostname
    this.token = token
    this.provider = provider
    this.organizationPublicKey = organizationPublicKey
    this.organizationPrivateKeyEncryptedWithUserPublicKey = organizationPrivateKeyEncryptedWithUserPublicKey
  ...
  async run () {
    ...
    const url = `${this.hostname}/api/cloak`
    const provider = this.provider
    const organizationPublicKey = this.organizationPublicKey
    const organizationPrivateKeyEncryptedWithUserPublicKey = this.organizationPrivateKeyEncryptedWithUserPublicKey
    ...
    const resp = await request(url, {
      ...
      body: JSON.stringify({
        ...
        organization_private_key_encrypted_with_user_public_key: organizationPrivateKeyEncryptedWithUserPublicKey,
