...
Describe 'install.sh'
  ...
  # remove the dotenvx-pro binary before each test
  cleanup() {
    rm -f ./spec/tmp/dotenvx-pro
  }
  ...
  Describe 'help_sudo_install_command'
    ...
    Describe 'when is_piped is true'
      ...
      It "returns with curl example"
        When call help_sudo_install_command
        The status should equal 0
        The output should equal "curl -sfS https://dotenvx.sh/pro | sudo $0"
      End
    End
  End
  ...
  Describe 'help_customize_directory_command'
    ...
    Describe 'when is_piped is true'
      ...
      It "returns with curl example"
        When call help_customize_directory_command
        The status should equal 0
        The output should equal "curl -sfS \"https://dotenvx.sh/pro?directory=.\" | $0"
      End
    End
  End
